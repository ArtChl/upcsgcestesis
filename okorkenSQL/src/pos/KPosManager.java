...
public class KPosManager
{
    ...
    public boolean registerSale(KDispatch dispatch)
    {
            ...
            try
        {
            ...
            String sentence = "INSERT INTO CEM44 (idventa, turno, fecha, surtidor, lado, manguera, cod_producto, volumen, ppu, monto, facturado) VALUES (";
            String maximun = "SELECT MAX(idventa) FROM CEM44 ";
                String nextNumber = "";
                try
                {
    ...
    private boolean connectcen()
    {
        ...
        try
        {
            ...
            //connectioncen = DriverManager.getConnection("jdbc:JSQLConnect://localhost/database=SUPERGRIFOBD/user=sa/password=12345678");
