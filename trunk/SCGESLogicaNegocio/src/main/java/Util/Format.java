...
public class Format
{
    ...
    public static String formatCant(String cantidad){
        return String.format("%1$-6s",cantidad);    
    }

    public static String formatProducto(String cantidad){
        return String.format("%1$-21s",cantidad);   
        
    }
    
    public static String formatPrecio(String cantidad){
        return String.format("%1$6s",cantidad);   
        
    }
    
    public static String formattotal(String cantidad){
        return String.format("%1$7s",cantidad);   
